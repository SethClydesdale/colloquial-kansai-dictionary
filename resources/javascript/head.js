  ...
  window.GenkiSettings = {
    manager : function () {
      ...
      GenkiModal.open({
        ...
        content : '<p>Here you can manage your settings for Colloquial Kansai Dictionary. To learn more about a setting, hover over its label for a short description.</p>'+
